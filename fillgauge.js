...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    // const radius = parseInt(gauge.style("width"), gauge.style("height")) / 2;
    ...
    console.log(circleFillGap)
    console.log(fillCircleMargin)
    console.log(fillCircleRadius)
    console.log(waveHeight)
    console.log(waveLength)
    console.log(waveClipCount)
    console.log(waveClipWidth)
