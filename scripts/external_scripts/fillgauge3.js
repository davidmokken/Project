...
var defaultConfig3 = {
    ...
    circleColor: "#d63a3a", // The color of the outer circle.
    backgroundColor: null, // The color of the background
    waveColor: "#bd3b3b", // The color of the fill wave.
    ...
    textColor: "#92140c", // The color of the value text when the wave does not overlap it.
    waveTextColor: "#92140c", // The color of the value text when the wave overlaps it.
};


d3.liquidfillgauge3 = function(g, value, settings) {
    
    // // Handle configuration
    var config = d3.map(defaultConfig3);
