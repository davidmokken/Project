...
var defaultConfig2 = {
    ...
    waveColor: "#AA7D39", // The color of the fill wave.
    ...
    textColor: "#553300", // The color of the value text when the wave does not overlap it.
    waveTextColor: "#805615", // The color of the value text when the wave overlaps it.
};
